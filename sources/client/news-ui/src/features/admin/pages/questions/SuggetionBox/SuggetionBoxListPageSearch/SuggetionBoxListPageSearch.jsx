...
import styles from './SuggetionBoxListPageSearch.module.scss';

const cx = classNames.bind(styles);

SuggetionBoxListPageSearch.propTypes = {};

SuggetionBoxListPageSearch.defaultProps = {};

function SuggetionBoxListPageSearch(props) {
...
export default SuggetionBoxListPageSearch;
