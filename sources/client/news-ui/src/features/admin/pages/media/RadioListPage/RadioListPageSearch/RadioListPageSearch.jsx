...
import styles from "./RadioListPageSearch.module.scss";

const cx = classNames.bind(styles);

RadioListPageSearch.propTypes = {};

RadioListPageSearch.defaultProps = {};

function RadioListPageSearch(props) {
...
export default RadioListPageSearch;
