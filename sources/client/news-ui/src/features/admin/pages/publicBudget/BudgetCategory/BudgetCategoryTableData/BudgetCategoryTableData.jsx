...
import styles from './BudgetCategoryTableData.module.scss';
...
BudgetCategoryTableData.propTypes = {
...
BudgetCategoryTableData.defaultProps = {};

function BudgetCategoryTableData(props) {
  const {
    data,
...
export default BudgetCategoryTableData;
