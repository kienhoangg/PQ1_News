...
import styles from './BudgetCategoryPageSearch.module.scss';
...
BudgetCategoryPageSearch.propTypes = {
  /**
...
BudgetCategoryPageSearch.defaultProps = {
  setTextSearch: () => {},
};

function BudgetCategoryPageSearch(props) {
...
export default BudgetCategoryPageSearch;
