...
import styles from './BudgetContentPageSearch.module.scss';
...
BudgetContentPageSearch.propTypes = {
  /**
...
BudgetContentPageSearch.defaultProps = {
  setTextSearch: () => {},
};

function BudgetContentPageSearch(props) {
...
export default BudgetContentPageSearch;
