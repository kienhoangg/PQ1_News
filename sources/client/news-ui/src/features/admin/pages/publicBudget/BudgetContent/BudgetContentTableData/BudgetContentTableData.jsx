...
import styles from './BudgetContentTableData.module.scss';
...
BudgetContentTableData.propTypes = {
...
BudgetContentTableData.defaultProps = {};

function BudgetContentTableData(props) {
  const {
    data,
...
export default BudgetContentTableData;
