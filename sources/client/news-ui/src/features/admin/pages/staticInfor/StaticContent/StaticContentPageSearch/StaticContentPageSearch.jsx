...
import styles from './StaticContentPageSearch.module.scss';
...
StaticContentPageSearch.propTypes = {
  /**
...
StaticContentPageSearch.defaultProps = {
  setTextSearch: () => {},
};

function StaticContentPageSearch(props) {
...
export default StaticContentPageSearch;
